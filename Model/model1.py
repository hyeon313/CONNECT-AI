...
if __name__ == '__main__':
    ...
    path = os.path.join(current_path, "logs", datetime.datetime.now().strftime("%Y%m%d-%H%M%S"))
    ...
    model.fit(source, target, epochs=100,verbose=1, validation_split=0.2, batch_size=8, callbacks=[tensorboard_callback, early_stopping, model_checkpoint])
