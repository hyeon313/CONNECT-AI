...
def data_load():
    img = np.load("C:/Users/yjm45/python/LD2HD/imgs.npy")
    mask = np.load("C:/Users/yjm45/python/LD2HD/masks.npy")
...
if __name__ == '__main__':
    ...
    model.fit(source, target, epochs=50, validation_split=0.1, batch_size=8)
