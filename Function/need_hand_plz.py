'''
수정 필요!
zoom in/ out (in은 되는데 out이 되지 않음 ㅜ)
좌표에서 z가 계속 바뀌도록 (move 함수에 들어가 있기에 마우스가 움직이지 않을 때 z를 바꾸기 어려울듯)
'''
...
class MyApp(QMainWindow):
    ...
    def initUI(self):
        ...
        self.wg.view_2.resize(self.wg.view_2.width() + 2, self.wg.view_2.height() + 2)
